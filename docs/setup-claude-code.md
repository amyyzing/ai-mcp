...
This adds the server to your local project configuration. To make it available to every project for the current user, use:

```bash
claude mcp add roblox-executor-mcp --scope user -- node /path/to/roblox-executor-mcp/dist/index.js
```
